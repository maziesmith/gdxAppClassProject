...
public class FuelTank {
    ...
    public float sizeX;
    public float sizeY;
    public int frameFuelCounter;
    public boolean isUsed;  //check if tank has been used

    public FuelTank(Sprite sprt_, float posX_, float posY_, float sizeX_,float sizeY_){
        sprt = sprt_;
        posX = posX_;
        posY = posY_;
        sizeX = sizeX_;
        ...
        frameFuelCounter = 0;   // to count frames to deplete fuel
